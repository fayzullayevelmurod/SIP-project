...
const Header = (props) => {
  ...
  const { handleToggleNav, activeNav, handleAbsoluteNav, absoluteNav, toggleHidden } = useContext(ShowNavContext);
    ...
    <>
      <header className="header">
        <div className="header-left">
          ...
          {dropdownLogo ? (
            <>
              <button className="logo-box" onClick={handleAbsoluteNav}>
                <img
